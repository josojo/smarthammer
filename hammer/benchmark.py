...
def submit_theorem_to_api(theorem: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
    ...
    payload = {
        ...
        "goal": goal,
        "ai_for_hypotheses_generation": AIForHypothesesProof.GEMINI_2_PAID.value,
        "ai_for_hypotheses_proof": [AIForHypothesesProof.GEMINI_2_PAID.value],
        "ai_for_final_proof": AIForHypothesesProof.GEMINI_2_PAID.value,
